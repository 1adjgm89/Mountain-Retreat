...
//images
import natureImmersion from './../../assets/img/Specialities/Nature-Immersion.jpg'
import tradition from './../../assets/img/Specialities/tradition.jpg'
import yoga from './../../assets/img/Specialities/yoga.jpg'
import nutrition from './../../assets/img/Specialities/nutrition.jpg'
import activities from './../../assets/img/Specialities/Mindfulness-Activities.jpg'
  ...
  return (
    ...
    <Tabs>
      ...
      <TabPanel className={"react-tabs__tab-panel bg-[#e1e6e6] py-12"}>
        ...
        <div className='lg:w-2/4 lg:px-16 sm:px-8 md:px-8 md:w-full sm:w-full lg:order-1 sm:order-2 md:order-2'>
            <h2 className='text-[32px] font-bold text-[#295b52] mb-5 sm:mt-4 md:mt-4'>NATURE IMMERSION</h2>
      ...
      <TabPanel className={"react-tabs__tab-panel bg-[#e1e6e6] py-12"}>
        <div className='flex lg:flex-row md:flex-col sm:flex-col'>
        <div className='lg:w-2/4 lg:px-16 sm:px-8 md:px-8 md:w-full sm:w-full lg:order-1 sm:order-2 md:order-2'>
            <h2 className='text-[32px] font-bold text-[#295b52] mb-5 sm:mt-4 md:mt-4'>TRADITION OF AYURVEDA</h2>
      ...
      <TabPanel className={"react-tabs__tab-panel bg-[#e1e6e6] py-12"}>
        <div className='flex lg:flex-row md:flex-col sm:flex-col'>
        <div className='lg:w-2/4 lg:px-16 sm:px-8 md:px-8 md:w-full sm:w-full lg:order-1 sm:order-2 md:order-2'>
            <h2 className='text-[32px] font-bold text-[#295b52] mb-5 sm:mt-4 md:mt-4'>RESTORATIVE YOGA AND MEDITATION</h2>
      ...
      <TabPanel className={"react-tabs__tab-panel bg-[#e1e6e6] py-12"}>
        <div className='flex lg:flex-row md:flex-col sm:flex-col'>
        <div className='lg:w-2/4 lg:px-16 sm:px-8 md:px-8 md:w-full sm:w-full lg:order-1 sm:order-2 md:order-2'>
            <h2 className='text-[32px] font-bold text-[#295b52] mb-5 sm:mt-4 md:mt-4'>WHOLESOME AYURVEDIC NUTRITION</h2>
      ...
      <TabPanel className={"react-tabs__tab-panel bg-[#e1e6e6] py-12"}>
        <div className='flex lg:flex-row md:flex-col sm:flex-col'>
        <div className='lg:w-2/4 lg:px-16 sm:px-8 md:px-8 md:w-full sm:w-full lg:order-1 sm:order-2 md:order-2'>
            <h2 className='text-[32px] font-bold text-[#295b52] mb-5 sm:mt-4 md:mt-4'>MINDFULNESS ACTIVITIES</h2>
